...
//   // 銆愬凡鍒犻櫎銆戝師鍏堝湪杩欓噷鍙戦�? K 鎸囦护 (TOGGLE_COORD) 鐨? useEffect 宸茬粡琚?绉婚??
...
//   // 銆愭柊澧炴牳蹇冮�昏緫銆戞牴鎹?褰撳墠涓嬫媺妗嗛�夋嫨鐨? Tool锛岀洿鎺ョ敓鎴愬己琛屽啓姝荤殑鍧愭爣浼犵粰瑙嗗浘
...
//   return (
//     <TestToolPageView
//       // 杩欓噷鍘熸湰鏄? coords={hardware.coords}锛岀幇鍦ㄦ浛鎹?涓轰笂闈㈣?＄畻鍑虹殑鍋囨暟鎹? displayCoords
...
export default function TestToolPage({ onStartGame, calibratedPayload = '0.5kg' }) {
  const hardware = useHardwareStore()
  const [status, setStatus] = useState('idle')
  const [showToast, setShowToast] = useState(false)
  const [showHintModal, setShowHintModal] = useState(false)
